...
public class custom_student_borrowed_books extends BaseAdapter {

    String [] date,due_date,book_info,status;
    private Context context;


    public custom_student_borrowed_books(Context applicationContext, String[] date, String[] due_date, String[] book_info, String[] status) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            gridView = inflator.inflate(R.layout.activity_custom_student_borrowed_books, null);//same class name
