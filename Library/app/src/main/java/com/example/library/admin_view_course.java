    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ij=new Intent(getApplicationContext(), admin_add_course.class);
                startActivity(ij);
            }
        });
        l1=findViewById(R.id.lv);
        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        url=sh.getString("url","")+"/and_view_course";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    course[i] = u.getString("cname");
                                    dept[i] = u.getString("dept");
                                }
                                l1.setAdapter(new custom_course(getApplicationContext(), cid, course, dept));//custom_view_service.xml and li is the listview object
