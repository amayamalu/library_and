...
public class Student_borrowed_books extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url=sh.getString("url","")+"/and_borrow_books";
...
//                        Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                l1.setAdapter(new custom_student_borrowed_books(getApplicationContext(),date,due_date,book_info,status));//custom_view_service.xml and li is the listview object
